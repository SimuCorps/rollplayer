...
BOT_NAME = "Rollplayer" # This shows up in /info.

VERSION = f"0.0.0+buildtime_{int(datetime.datetime.now().timestamp())}" # This shows up in /info.
...
EMBED = {"COLOR": 0xff8a8c, "FOOTER": f"Rollplayer testing | v{VERSION}"} # This is for the embed templates.
