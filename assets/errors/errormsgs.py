messages = [
    ...
    # ONE DAY THERE WILL BE TAGS I SWEAR IF YOU'RE READING THIS HOLD ME ACCOUNTABLE LEGI
    ...
    "I have a good feeling this is about as buggy as Windows ME.",
    "Ok, so if you want to fix this, all you need to do is",
    "take this L",
    "Do you notice that the code is not working? If so, good! Please proceed to the keyboard smashing station ahead of you, right by the Complaint Incinerator.",
    "Better not make that worse...",
    "(insert message here)",
    ...
    "I think the syntax gave the 8ball a heart attack. Do you have some more of that blue fluid that goes in them?",
    "The unfunny happened.",
    "The calm before the storm... but the storm already happened.",
    "from utils.logging import log\nlog.error(\"Code broke how sad...\")",
    "You're a surgeon now, dissect the code and send a pull request!",
    "Either the code broke or THE code broke.",
    "Print out your /avatar. Then throw it in the fire.",
    ...
    "The choice has been made! The code shall raise an exception!!",
    ...
    "Wanna break from the error messages? If you fix your invalid rolling syntax now and watch a short video, you'll recieve 30 minutes of error-free rolling.",
    "Running your command has caused an abnormality in the interpreter!",
    ...
    "Just stick some error messages from another bot in there. They'll never figure out the source.",
    ...
    "Read over your command again. Maybe you missed something.",
    ...
    "name 'RollplayerLibraryException' is not defined",
    "I should make the translators translate all of these exceptions... it'd be really funny.",
    ]